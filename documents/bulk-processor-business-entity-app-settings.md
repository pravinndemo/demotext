...
BulkProcessorProcessingStatusColumnName=voa_processingstatus
...
SvtProcessingEntityLogicalName=voa_svtprocessing
SvtProcessingCorrelationIdColumnName=voa_correlationid
SvtProcessingSsuIdColumnName=voa_ssuid
SvtProcessingUserIdColumnName=voa_userid
SvtProcessingComponentNameColumnName=voa_componentname
SvtProcessingDispatchStateColumnName=voa_dispatchstate
SvtProcessingStatusColumnName=voa_status
SvtProcessingRequestLookupColumnName=voa_requestid
SvtProcessingJobLookupColumnName=voa_jobid
SvtProcessingErrorCodeColumnName=voa_errorcode
SvtProcessingErrorMessageColumnName=voa_errormessage
SvtProcessingAttemptCountColumnName=voa_attemptcount
SvtProcessingRequestedOnColumnName=voa_requestedon
SvtProcessingRequestCreatedOnColumnName=voa_requestcreatedon
SvtProcessingJobCreatedOnColumnName=voa_jobcreatedon
SvtProcessingCompletedOnColumnName=voa_completedon
SvtProcessingIsRetryableColumnName=voa_isretryable
SvtProcessingPayloadSummaryColumnName=voa_payloadsummary
